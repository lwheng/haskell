...
{- The operators we are supporting -}
data Op = Plus | Minus | Mul | Div | Pow
    deriving (Eq, Show)

{- Forgot the actual term for this, but it is like the backbone
...
{- We just defined instances for Num, Fractional and Floating -}
...
{- Show a SymbolicManip using RPN. Imagine all the numbers and operators
 - are on a stack -}
...
{- Helper function to easily create simple expressions -}
units :: (Num z) => z -> String -> Units z
units a b = Units a (Symbol b)

{- Helper function to easily extract the embedded Num -}
